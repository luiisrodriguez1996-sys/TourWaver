...
const translations = {
  ...
  pt: {
    ...
    heroTitleHighlight: "Tours 360°",
    heroTitleEnd: "",
    heroDesc: "Ajudamos corretores e imobiliárias a destacar suas propiedades como um negocio innovador. Criamos experiências inmersivas que permiten aos seus clientes visitar seu futuro lar de qualquer lugar do mundo.",
    ...
    footerCopy: "© 2026 Vistar - Servicios de Visualización 360°. Todos os derechos reservados.",
