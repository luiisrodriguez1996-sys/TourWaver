...
const content = {
  ...
  pt: {
    ...
    updated: "Última atualização: Março 2024",
    ...
    text2: "Você concorda em usar a plataforma de forma ética e profissional. Não é permitido o uso de imagens que não lhe pertençam ou para as quais você não tenha direitos de distribuição.",
    section3: "3. Propriedade Intelectual",
    text3: "O software, design e marcas associadas ao Tour Weaver são de propriedade exclusiva da empresa. Os tours gerados são de propriedade do cliente de acordo com o contrato de serviço específico."
  }
};
