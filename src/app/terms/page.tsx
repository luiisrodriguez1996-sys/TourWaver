...
const content = {
  es: {
    ...
    text4: "El software, diseño y marcas asociadas a Vistar son propiedad exclusiva de la empresa. Los tours generados son propiedad del cliente según el contrato de servicio específico."
  },
  en: {
    title: "Terms of Use",
    back: "Back to Home",
    ...
    text1: "By accessing and using Vistar, you agree to be bound by these terms of service. Our services are designed for real estate professionals looking to improve their property visualization.",
    section2: "2. Nature of Service (Exclusion of Transactions)",
    text2: "Vistar is exclusively a technological visualization platform. We do not perform, facilitate, or intervene in sales, rentals, or other real estate transactions. We are not a real estate agency or a classifieds portal; our service is limited solely to the creation and display of 360° virtual tours.",
    ...
    text4: "The software, design, and trademarks associated with Vistar are the exclusive property of the company. Generated tours are property of the client according to the specific service contract."
  },
  pt: {
    title: "Termos de Uso",
    ...
    text4: "O software, diseño e marcas associadas ao Vistar são de propriedade exclusiva da empresa. Os tours generados são de propriedade do cliente de acordo com o contrato de serviço específico."
  }
};
