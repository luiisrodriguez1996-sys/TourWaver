...
### Características v1.5.3:
- **Blindaje de Credenciales**: Eliminación total de claves de API hardcodeadas. Uso exclusivo de variables de entorno para máxima seguridad en repositorios.
